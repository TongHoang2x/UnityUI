...
public class MenuLeanTween : MonoBehaviour
{
    [SerializeField]
    ...
    void Start()
    {
        Vector3 levelPosStart = levelSucess.gameObject.transform.localPosition;
        Debug.Log(levelPosStart);
        ...
        LeanTween.moveLocal(levelSucess, new Vector3(0f, 0f, 0f), 0.7f).setDelay(2f).setEase(LeanTweenType.easeInOutCubic);
